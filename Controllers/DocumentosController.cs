...
namespace PortariaInteligente.Controllers
{
   // [Authorize]
    public class DocumentosController : Controller
    {
        ...
        public DocumentosController(PortariaInteligenteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DocumentoId,nomeDocumento")] Documento documento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DocumentoId,nomeDocumento")] Documento documento)
        {
